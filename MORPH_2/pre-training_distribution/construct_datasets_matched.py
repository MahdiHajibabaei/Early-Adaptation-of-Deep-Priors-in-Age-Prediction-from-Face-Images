...
resampling_scale = 4 * IMDB_sample_number/LAP_sample_number
...
for age in xrange(0,101):
	if (LAP_age_distribution[age])>0:
		...
		required_samples=LAP_age_distribution[age]*resampling_scale
...
base_address=''
dataset = open(base_address+'morph_matched_test_set.txt','w+')
