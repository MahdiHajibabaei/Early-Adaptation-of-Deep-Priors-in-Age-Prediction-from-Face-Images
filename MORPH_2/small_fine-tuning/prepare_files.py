...
portions=[[0.000625,32],[0.0017,32]]#,[0.00375,32],[0.005,32],[0.01,16],[0.02,8],[0.04,4],[0.08,2],[0.16,1],[0.2,1],[0.4,1],[0.8,1]]
stepsize=["2","4"]#,"10","13","25","50","100","200","400","500","1000","2000"]
max_iter=["10","20"]#,"50","65","125","250","500","1000","2000","2500","5000","10000"]
...
for p in portions:
	for index in xrange(0,p[1]):
		...
		with open('2_1_train_val.prototxt', 'r') as file :
  			filedata = file.read()
		...
		Network_address='Learning_curve_prototxts_'+GPU_index+'/DEX_'+str(p[0])+'_'+str(index)+'.prototxt'
		with open(Network_address, 'w') as file:
  			file.write(filedata)	

		#Create the solvers
		Network_address=CWD+Network_address
		Solver_address='Learning_curve_prototxts_'+GPU_index+'/DEX_solver_'+str(p[0])+'_'+str(index)+'.prototxt'
		...
		solver_text.write("snapshot_prefix: \"/srv/glusterfs/hmahdi/IMDB/LC_snapshot_"+GPU_index+"/Fine_tune_"+str(p[0])+'_'+str(index)+"\"\n")
