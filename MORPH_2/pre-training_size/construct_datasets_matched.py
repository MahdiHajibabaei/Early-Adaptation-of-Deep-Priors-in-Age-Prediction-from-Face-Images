...
Imagelist='/home/hmahdi/caffe/examples/morph/fine-tuning/2_1_test.txt'
inputfile = open(Imagelist,'r')
...
#Reduction_ratio=0.000331# for training 100 samples
#Reduction_ratio=0.00078# for validation 13 samples

#Reduction_ratio=0.00279# for 10000 samples

Reduction_ratio=0.02721 # for 10000 samples
...
base_address=''
dataset = open(base_address+'MORPH_matched_10000_test_set.txt','w+')
